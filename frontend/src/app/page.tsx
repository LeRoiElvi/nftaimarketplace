  ...
  <div className="absolute top-1/4 right-1/4 w-72 h-72 bg-blue-3 rounded-full blur-3xl opacity-20"></div>
        ...
        <div className="max-w-7xl mx-auto text-center relative z-10">
          <div className="mb-12">
            ...
            <span className="text-gray-12 block">
  Hello there,
</span>
<span className="text-blue-11 block">
  I&apos;m Elvis!
</span>
          ...
          <button className="group px-6 py-3 bg-blue-9 hover:bg-blue-10 text-blue-contrast font-medium text-base rounded-lg transition-colors border border-blue-9 hover:border-blue-10">
            ...
            <button className="group px-6 py-3 bg-gray-3 hover:bg-gray-4 text-gray-12 hover:text-gray-12 font-medium text-base rounded-lg transition-colors border border-gray-6 hover:border-gray-7">
              <span className="flex items-center gap-3">
      ...
      <main className="max-w-7xl mx-auto px-6">
        ...
        <section className="mb-20">
          <div className="relative">
            ...
            <div className="relative bg-gray-1 rounded-2xl p-1">
              <div className="bg-gradient-to-br from-gray-1 to-blue-1 rounded-xl p-8 md:p-12">
                <div className="max-w-4xl mx-auto text-center">
                  ...
                  <div className="text-lg text-gray-11 leading-relaxed space-y-6">
                    <p>
                      Hi, I&apos;m <span className="text-blue-11 font-semibold">Elvis</span>, a marketing project manager for a listed company leveraging blockchain technology in the video game industry, <span className="text-blue-11 font-semibold">CBI</span>. 
                      Here on my website you can find my personal projects, my NFT collection, and my coding journey so far! 
                    </p>
                    <p>
                      I heard about <span className="text-blue-11 font-semibold">vibe coding</span> earlier this year, and I was always interested in coding, so I decided to give it a try.
                      In June 2025 I started my coding journey. I&apos;m currently learning <span className="text-blue-11 font-semibold">React, Next.js, and Tailwind CSS</span>. 
        ...
        <section className="mb-24">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-11 max-w-2xl mx-auto leading-relaxed">
              Discover what I&apos;ve been building in the past months. By leveraging <span className="text-blue-11 font-semibold">AI and powerful tools</span>, it has never been easier to bring an idea to life. 
            </p>
          </div>
          
          <div className="grid md:grid-cols-3 gap-8">
            {/* Card 1 - Enhanced with blue accents */}
            <div className="group relative bg-gray-2 border border-gray-6 rounded-lg p-6 hover:bg-gray-3 hover:border-gray-7 transition-colors">
              <div className="relative z-10 p-8 text-center">
                ...
                <h3 className="text-2xl font-bold text-gray-12 mb-4">
                  <span className="text-blue-11">Vibe Code</span> Journey
                </h3>
                <p className="text-gray-11 leading-relaxed">Here you can find my entire coding journey, keep track of my improvements and advancement.</p>
                <div className="mt-6 inline-flex items-center text-blue-11 font-semibold group-hover:text-blue-12 transition-colors">
                  Learn More 
            ...
            <div className="group relative rounded-2xl overflow-hidden bg-gradient-to-br from-blue-4 to-blue-6 border-2 border-blue-8 shadow-2xl shadow-blue-9/30 hover:shadow-blue-9/50 transition-all duration-300 hover:-translate-y-2 scale-105">
              ...
              <div className="relative z-10 p-8 text-center">
                ...
                <p className="text-blue-12 leading-relaxed font-medium">In this section you can discover my NFTs and other blockchain projects I&apos;ve worked on.</p>
            ...
            {/* Card 3 */}
            <div className="group relative rounded-2xl overflow-hidden bg-gradient-to-br from-gray-1 to-blue-1 border-2 border-blue-5 hover:border-blue-7 shadow-lg hover:shadow-2xl hover:shadow-blue-9/20 transition-all duration-300 hover:-translate-y-2">
              ...
              <div className="relative z-10 p-8 text-center">
                ...
                <h3 className="text-2xl font-bold text-gray-12 mb-4">
                  <span className="text-blue-11">Community</span> Driven
                </h3>
                <p className="text-gray-11 leading-relaxed">Join a vibrant community of collectors, artists, and NFT enthusiasts.</p>
                <div className="mt-6 inline-flex items-center text-blue-11 font-semibold group-hover:text-blue-12 transition-colors">
                  Join Community 
                  <svg className="w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
        ...
        <section id="nfts" className="mb-24">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-11 max-w-2xl mx-auto leading-relaxed">
              Here&apos;s the first NFT I&apos;ve minted, inspired by one of my favorite games ever, <span className="text-blue-11 font-semibold">Minecraft</span>. I named it the <span className="text-blue-11 font-semibold">elvisminecraftcollection</span> and deployed it on the <span className="text-blue-11 font-semibold">Polygon Amoy testnet</span>.
            </p>
          </div>
          ...
          <div className="relative">
            ...
            <div className="relative bg-gradient-to-br from-gray-1 via-blue-1 to-blue-2 rounded-2xl p-2 border-2 border-blue-6">
              <div className="bg-gray-1 rounded-xl p-8 border border-blue-4">
                <ShowcaseNFT />
              </div>
            </div>
          </div>
      ...
      {/* Footer - new with socials from component */}
    <Footer /> 
    </div>
  );
}